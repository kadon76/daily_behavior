class StudentDataController < ApplicationController
  ...
  def student_graph
    ...
    render :json => {
      :type => 'ColumnChart',
      :cols => [['string', 'Behavior'], ['number', 'Number']],
      :rows => [
        ['On Task', theseBehaviors[0]],
        ['Positive Interactions', theseBehaviors[1]],
        ['Safety', theseBehaviors[2]],
        ['B.I.P. Goal', theseBehaviors[3]],
        ['Defiant', theseBehaviors[4]],
        ['Disrespectful', theseBehaviors[5]],
        ['Disruptive', theseBehaviors[6]],
        ['Property Distruction', theseBehaviors[7]],
        ['Threatening', theseBehaviors[8]],
        ['Obsenity', theseBehaviors[9]],
        ['Physical Aggression', theseBehaviors[10]],
        ['Verbal Aggression', theseBehaviors[11]],
        ['AWOL', theseBehaviors[12]],
        ['Sleeping', theseBehaviors[13]],
        ['Provoking/Mocking', theseBehaviors[14]],
        ['Self-Injurious', theseBehaviors[15]],
        ['Repeat Offense', theseBehaviors[16]],
        ['B.I.P. Goal', theseBehaviors[17]],
        ['Tardy', theseBehaviors[18]],
        ['Other', theseBehaviors[19]],
        ['Time Away', theseBehaviors[20]],
        ['Time Out', theseBehaviors[21]],
        ['Seclusion', theseBehaviors[22]],
        ['Restraint', theseBehaviors[23]],
      ],
      :options => {
        :title => 'Behaviors',
        :legend => 'none',
